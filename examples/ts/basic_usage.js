...
const client_1 = require("../../sdks/ts/src/client");
const math_1 = require("../../sdks/ts/src/math");
async function main() {
    const client = new client_1.HyperspaceClient('localhost:50051', 'I_LOVE_HYPERSPACEDB');
    ...
    try {
        ...
        try {
            ...
            const entropy = (0, math_1.localEntropy)(thoughtVector, contextNeighbors);
