...
class DatabaseClient extends $grpc.Client {
  ...
  static final _$vectorize =
      $grpc.ClientMethod<$0.VectorizeRequest, $0.VectorizeResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.VectorizeResponse.fromBuffer(value));
  ...
  static final _$getPoints =
      $grpc.ClientMethod<$0.GetPointsRequest, $0.GetPointsResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.GetPointsResponse.fromBuffer(value));
  ...
  static final _$scroll =
      $grpc.ClientMethod<$0.ScrollRequest, $0.ScrollResponse>(
          ...
          ($core.List<$core.int> value) => $0.ScrollResponse.fromBuffer(value));
  ...
  static final _$searchBatch =
      $grpc.ClientMethod<$0.BatchSearchRequest, $0.BatchSearchResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.BatchSearchResponse.fromBuffer(value));
  static final _$searchMultiCollection = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $0.SearchMultiCollectionResponse.fromBuffer(value));
  static final _$getNode = $grpc.ClientMethod<$0.GetNodeRequest, $0.GraphNode>(
      ...
      ($core.List<$core.int> value) => $0.GraphNode.fromBuffer(value));
  static final _$getNeighbors =
      $grpc.ClientMethod<$0.GetNeighborsRequest, $0.GetNeighborsResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.GetNeighborsResponse.fromBuffer(value));
  static final _$getConceptParents = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $0.GetConceptParentsResponse.fromBuffer(value));
  static final _$traverse =
      $grpc.ClientMethod<$0.TraverseRequest, $0.TraverseResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.TraverseResponse.fromBuffer(value));
  static final _$findSemanticClusters = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $0.FindSemanticClustersResponse.fromBuffer(value));
  static final _$monitor =
      $grpc.ClientMethod<$0.MonitorRequest, $0.SystemStats>(
          ...
          ($core.List<$core.int> value) => $0.SystemStats.fromBuffer(value));
  ...
  static final _$replicate =
      $grpc.ClientMethod<$0.ReplicationRequest, $0.ReplicationLog>(
          ...
          ($core.List<$core.int> value) => $0.ReplicationLog.fromBuffer(value));
  static final _$subscribeToEvents =
      $grpc.ClientMethod<$0.EventSubscriptionRequest, $0.EventMessage>(
          ...
          ($core.List<$core.int> value) => $0.EventMessage.fromBuffer(value));
  static final _$getDigest =
      $grpc.ClientMethod<$0.DigestRequest, $0.DigestResponse>(
          ...
          ($core.List<$core.int> value) => $0.DigestResponse.fromBuffer(value));
  ...
  static final _$syncHandshake =
      $grpc.ClientMethod<$0.SyncHandshakeRequest, $0.SyncHandshakeResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.SyncHandshakeResponse.fromBuffer(value));
  ...
  static final _$syncPush =
      $grpc.ClientMethod<$0.SyncVectorData, $0.SyncPushResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.SyncPushResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.ScrollResponse> scroll($0.ScrollRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$scroll, request, options: options);
  }

  $grpc.ResponseFuture<$0.CountResponse> count($0.CountRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.GraphNode> getNode($0.GetNodeRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.TraverseResponse> traverse($0.TraverseRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseStream<$0.SystemStats> monitor($0.MonitorRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.StatusResponse> triggerSnapshot($0.Empty request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$triggerSnapshot, request, options: options);
  }

  $grpc.ResponseFuture<$0.StatusResponse> triggerVacuum($0.Empty request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.StatusResponse> configure($0.ConfigUpdate request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.DigestResponse> getDigest($0.DigestRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseStream<$0.SyncVectorData> syncPull($0.SyncPullRequest request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
  ...
  $grpc.ResponseFuture<$0.HealthCheckResponse> healthCheck($0.Empty request,
      {$grpc.CallOptions? options}) {
...
abstract class DatabaseServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.GraphNode> getNode_Pre(
      $grpc.ServiceCall call, $async.Future<$0.GetNodeRequest> request) async {
  ...
  $async.Future<$0.TraverseResponse> traverse_Pre(
      $grpc.ServiceCall call, $async.Future<$0.TraverseRequest> request) async {
  ...
  $async.Stream<$0.SystemStats> monitor_Pre(
