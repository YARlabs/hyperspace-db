...
class DatabaseClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.StatusResponse> freezeCollection(
    $0.FreezeCollectionRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$freezeCollection, request, options: options);
  }

  $grpc.ResponseFuture<$0.StatusResponse> unfreezeCollection(
    $0.UnfreezeCollectionRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$unfreezeCollection, request, options: options);
  }
  ...
  $grpc.ResponseFuture<$0.GetSubsumptionTreeResponse> getSubsumptionTree(
    $0.GetSubsumptionTreeRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$getSubsumptionTree, request, options: options);
  }
  ...
  static final _$freezeCollection =
      $grpc.ClientMethod<$0.FreezeCollectionRequest, $0.StatusResponse>(
          '/hyperspace.Database/FreezeCollection',
          ($0.FreezeCollectionRequest value) => value.writeToBuffer(),
          $0.StatusResponse.fromBuffer);
  static final _$unfreezeCollection =
      $grpc.ClientMethod<$0.UnfreezeCollectionRequest, $0.StatusResponse>(
          '/hyperspace.Database/UnfreezeCollection',
          ($0.UnfreezeCollectionRequest value) => value.writeToBuffer(),
          $0.StatusResponse.fromBuffer);
  ...
  static final _$getSubsumptionTree = $grpc.ClientMethod<
          $0.GetSubsumptionTreeRequest, $0.GetSubsumptionTreeResponse>(
      '/hyperspace.Database/GetSubsumptionTree',
      ($0.GetSubsumptionTreeRequest value) => value.writeToBuffer(),
      $0.GetSubsumptionTreeResponse.fromBuffer);
...
abstract class DatabaseServiceBase extends $grpc.Service {
  ...
  DatabaseServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.FreezeCollectionRequest, $0.StatusResponse>(
            'FreezeCollection',
            freezeCollection_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.FreezeCollectionRequest.fromBuffer(value),
            ($0.StatusResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.UnfreezeCollectionRequest, $0.StatusResponse>(
            'UnfreezeCollection',
            unfreezeCollection_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.UnfreezeCollectionRequest.fromBuffer(value),
            ($0.StatusResponse value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$0.GetSubsumptionTreeRequest,
            $0.GetSubsumptionTreeResponse>(
        'GetSubsumptionTree',
        getSubsumptionTree_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GetSubsumptionTreeRequest.fromBuffer(value),
        ($0.GetSubsumptionTreeResponse value) => value.writeToBuffer()));
  ...
  $async.Future<$0.StatusResponse> freezeCollection_Pre($grpc.ServiceCall $call,
      $async.Future<$0.FreezeCollectionRequest> $request) async {
    return freezeCollection($call, await $request);
  }

  $async.Future<$0.StatusResponse> freezeCollection(
      $grpc.ServiceCall call, $0.FreezeCollectionRequest request);

  $async.Future<$0.StatusResponse> unfreezeCollection_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.UnfreezeCollectionRequest> $request) async {
    return unfreezeCollection($call, await $request);
  }

  $async.Future<$0.StatusResponse> unfreezeCollection(
      $grpc.ServiceCall call, $0.UnfreezeCollectionRequest request);
  ...
  $async.Future<$0.GetSubsumptionTreeResponse> getSubsumptionTree_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetSubsumptionTreeRequest> $request) async {
    return getSubsumptionTree($call, await $request);
  }

  $async.Future<$0.GetSubsumptionTreeResponse> getSubsumptionTree(
      $grpc.ServiceCall call, $0.GetSubsumptionTreeRequest request);
