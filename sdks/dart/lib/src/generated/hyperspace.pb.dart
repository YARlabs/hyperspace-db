...
class CreateCollectionOp extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'hyperspace'),
      createEmptyInstance: create)
    ..aI(1, _omitFieldNames ? '' : 'dimension', fieldType: $pb.PbFieldType.OU3)
  ...
  @$pb.TagNumber(1)
  set dimension($core.int value) => $_setUnsignedInt32(0, value);
  @$pb.TagNumber(1)
...
class CreateCollectionRequest extends $pb.GeneratedMessage {
  factory CreateCollectionRequest({
    ...
    $core.int? dimension,
    $core.String? metric,
    $core.Iterable<CollectionComponent>? components,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<CollectionComponent>(4, _omitFieldNames ? '' : 'components',
        subBuilder: CollectionComponent.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  $pb.PbList<CollectionComponent> get components => $_getList(3);
}
...
class CollectionSummary extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$fixnum.Int64>(2, _omitFieldNames ? '' : 'count', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aI(3, _omitFieldNames ? '' : 'dimension', fieldType: $pb.PbFieldType.OU3)
  ...
  @$pb.TagNumber(3)
  set dimension($core.int value) => $_setUnsignedInt32(2, value);
  @$pb.TagNumber(3)
...
class CollectionStatsResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  $fixnum.Int64 get indexingQueue => $_getI64(3);
  @$pb.TagNumber(4)
  set indexingQueue($fixnum.Int64 value) => $_setInt64(3, value);
  @$pb.TagNumber(4)
  $core.bool hasIndexingQueue() => $_has(3);
  @$pb.TagNumber(4)
  void clearIndexingQueue() => $_clearField(4);

  @$pb.TagNumber(5)
  $fixnum.Int64 get diskUsageBytes => $_getI64(4);
  @$pb.TagNumber(5)
  set diskUsageBytes($fixnum.Int64 value) => $_setInt64(4, value);
  @$pb.TagNumber(5)
  $core.bool hasDiskUsageBytes() => $_has(4);
  @$pb.TagNumber(5)
  void clearDiskUsageBytes() => $_clearField(5);

  @$pb.TagNumber(6)
  $fixnum.Int64 get ramUsageBytes => $_getI64(5);
  @$pb.TagNumber(6)
  set ramUsageBytes($fixnum.Int64 value) => $_setInt64(5, value);
  @$pb.TagNumber(6)
  $core.bool hasRamUsageBytes() => $_has(5);
  @$pb.TagNumber(6)
  void clearRamUsageBytes() => $_clearField(6);

  @$pb.TagNumber(7)
  $fixnum.Int64 get activeTasks => $_getI64(6);
  @$pb.TagNumber(7)
  set activeTasks($fixnum.Int64 value) => $_setInt64(6, value);
  @$pb.TagNumber(7)
  $core.bool hasActiveTasks() => $_has(6);
  @$pb.TagNumber(7)
