...
final $typed_data.Uint8List edgeTypeDescriptor = $convert.base64Decode(
    'CghFZGdlVHlwZRILCgdVTktOT1dOEAASDgoKU0lNSUxBUklUWRABEg0KCUhJRVJBUkNIWRAC');

@$core.Deprecated('Use traversalModeDescriptor instead')
const TraversalMode$json = {
  '1': 'TraversalMode',
  '2': [
    {'1': 'GREEDY', '2': 0},
    {'1': 'DIFFUSIVE', '2': 1},
...
/// Descriptor for `TraversalMode`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List traversalModeDescriptor = $convert.base64Decode(
    'Cg1UcmF2ZXJzYWxNb2RlEgoKBkdSRUVEWRAAEg0KCURJRkZVU0lWRRABEgwKCE1PTUVOVFVNEA'
    'I=');
...
final $typed_data.Uint8List createCollectionOpDescriptor = $convert.base64Decode(
    'ChJDcmVhdGVDb2xsZWN0aW9uT3ASOQoGc2NoZW1hGAMgASgLMhwuaHlwZXJzcGFjZS5Db2xsZW'
    'N0aW9uU2NoZW1hSABSBnNjaGVtYYgBAUIJCgdfc2NoZW1hSgQIARACSgQIAhAD');
...
final $typed_data.Uint8List createCollectionRequestDescriptor = $convert.base64Decode(
    'ChdDcmVhdGVDb2xsZWN0aW9uUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEjkKBnNjaGVtYR'
    'gFIAEoCzIcLmh5cGVyc3BhY2UuQ29sbGVjdGlvblNjaGVtYUgAUgZzY2hlbWGIAQFCCQoHX3Nj'
    'aGVtYUoECAIQA0oECAMQBEoECAQQBQ==');

@$core.Deprecated('Use vectorComponentDescriptor instead')
const VectorComponent$json = {
  '1': 'VectorComponent',
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    {'1': 'metric', '3': 2, '4': 1, '5': 9, '10': 'metric'},
    {'1': 'full_dimension', '3': 3, '4': 1, '5': 13, '10': 'fullDimension'},
    {'1': 'weight', '3': 4, '4': 1, '5': 2, '10': 'weight'},
  ],
};

/// Descriptor for `VectorComponent`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List vectorComponentDescriptor = $convert.base64Decode(
    'Cg9WZWN0b3JDb21wb25lbnQSEgoEbmFtZRgBIAEoCVIEbmFtZRIWCgZtZXRyaWMYAiABKAlSBm'
    '1ldHJpYxIlCg5mdWxsX2RpbWVuc2lvbhgDIAEoDVINZnVsbERpbWVuc2lvbhIWCgZ3ZWlnaHQY'
    'BCABKAJSBndlaWdodA==');
...
const MrlLayer$json = {
  ...
  '2': [
    ...
    {'1': 'cutoff_dimension', '3': 2, '4': 1, '5': 13, '10': 'cutoffDimension'},
    {'1': 'store_in_ram', '3': 3, '4': 1, '5': 8, '10': 'storeInRam'},
    {'1': 'rerank_top_k', '3': 4, '4': 1, '5': 13, '10': 'rerankTopK'},
  ],
};

/// Descriptor for `MrlLayer`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mrlLayerDescriptor = $convert.base64Decode(
    'CghNcmxMYXllchIlCg5jb21wb25lbnRfbmFtZRgBIAEoCVINY29tcG9uZW50TmFtZRIpChBjdX'
    'RvZmZfZGltZW5zaW9uGAIgASgNUg9jdXRvZmZEaW1lbnNpb24SIAoMc3RvcmVfaW5fcmFtGAMg'
    'ASgIUgpzdG9yZUluUmFtEiAKDHJlcmFua190b3BfaxgEIAEoDVIKcmVyYW5rVG9wSw==');
...
final $typed_data.Uint8List collectionSchemaDescriptor = $convert.base64Decode(
    'ChBDb2xsZWN0aW9uU2NoZW1hEjsKCmNvbXBvbmVudHMYASADKAsyGy5oeXBlcnNwYWNlLlZlY3'
    'RvckNvbXBvbmVudFIKY29tcG9uZW50cxI/ChBjYXNjYWRlX3BpcGVsaW5lGAIgAygLMhQuaHlw'
    'ZXJzcGFjZS5NcmxMYXllclIPY2FzY2FkZVBpcGVsaW5l');
...
final $typed_data.Uint8List collectionSummaryDescriptor = $convert.base64Decode(
    ...
    'Vjb3VudBI5CgZzY2hlbWEYBSABKAsyHC5oeXBlcnNwYWNlLkNvbGxlY3Rpb25TY2hlbWFIAFIG'
    'c2NoZW1hiAEBQgkKB19zY2hlbWFKBAgDEARKBAgEEAU=');
...
final $typed_data.Uint8List collectionStatsResponseDescriptor = $convert.base64Decode(
    'ChdDb2xsZWN0aW9uU3RhdHNSZXNwb25zZRIUCgVjb3VudBgBIAEoBFIFY291bnQSJQoOaW5kZX'
    'hpbmdfcXVldWUYBCABKARSDWluZGV4aW5nUXVldWUSKAoQZGlza191c2FnZV9ieXRlcxgFIAEo'
    'BFIOZGlza1VzYWdlQnl0ZXMSJgoPcmFtX3VzYWdlX2J5dGVzGAYgASgEUg1yYW1Vc2FnZUJ5dG'
    'VzEiEKDGFjdGl2ZV90YXNrcxgHIAEoBFILYWN0aXZlVGFza3MSOQoGc2NoZW1hGAggASgLMhwu'
    'aHlwZXJzcGFjZS5Db2xsZWN0aW9uU2NoZW1hSABSBnNjaGVtYYgBAUIJCgdfc2NoZW1hSgQIAh'
    'ADSgQIAxAE');
...
final $typed_data.Uint8List insertRequestDescriptor = $convert.base64Decode(
    ...
    'ZXJ0UmVxdWVzdC5UeXBlZE1ldGFkYXRhRW50cnlSDXR5cGVkTWV0YWRhdGESHQoHcGF5bG9hZB'
    'gJIAEoDEgAUgdwYXlsb2FkiAEBGjsKDU1ldGFkYXRhRW50cnkSEAoDa2V5GAEgASgJUgNrZXkS'
    'FAoFdmFsdWUYAiABKAlSBXZhbHVlOgI4ARpbChJUeXBlZE1ldGFkYXRhRW50cnkSEAoDa2V5GA'
    'EgASgJUgNrZXkSLwoFdmFsdWUYAiABKAsyGS5oeXBlcnNwYWNlLk1ldGFkYXRhVmFsdWVSBXZh'
    'bHVlOgI4AUIKCghfcGF5bG9hZA==');
...
const SearchTextRequest$json = {
  ...
  '2': [
    ...
    {'1': 'include_payload', '3': 8, '4': 1, '5': 8, '10': 'includePayload'},
    {
      '1': 'component_weights',
      '3': 9,
      '4': 3,
      '5': 11,
      '6': '.hyperspace.SearchTextRequest.ComponentWeightsEntry',
      '10': 'componentWeights'
    },
  ],
  '3': [
    SearchTextRequest_FilterEntry$json,
    SearchTextRequest_ComponentWeightsEntry$json
  ],
  '8': [
    {'1': '_bm25_options'},
    {'1': '_hybrid_alpha'},
...
@$core.Deprecated('Use searchTextRequestDescriptor instead')
const SearchTextRequest_ComponentWeightsEntry$json = {
...
final $typed_data.Uint8List searchTextRequestDescriptor = $convert.base64Decode(
    ...
    'JpZF9hbHBoYRgHIAEoAkgBUgtoeWJyaWRBbHBoYYgBARInCg9pbmNsdWRlX3BheWxvYWQYCCAB'
    'KAhSDmluY2x1ZGVQYXlsb2FkEmAKEWNvbXBvbmVudF93ZWlnaHRzGAkgAygLMjMuaHlwZXJzcG'
    'FjZS5TZWFyY2hUZXh0UmVxdWVzdC5Db21wb25lbnRXZWlnaHRzRW50cnlSEGNvbXBvbmVudFdl'
    'aWdodHMaOQoLRmlsdGVyRW50cnkSEAoDa2V5GAEgASgJUgNrZXkSFAoFdmFsdWUYAiABKAlSBX'
    'ZhbHVlOgI4ARpDChVDb21wb25lbnRXZWlnaHRzRW50cnkSEAoDa2V5GAEgASgJUgNrZXkSFAoF'
    'dmFsdWUYAiABKAJSBXZhbHVlOgI4AUIPCg1fYm0yNV9vcHRpb25zQg8KDV9oeWJyaWRfYWxwaG'
    'E=');
...
const SearchRequest$json = {
  ...
  '2': [
    ...
    {'1': 'include_payload', '3': 11, '4': 1, '5': 8, '10': 'includePayload'},
    {
      '1': 'component_weights',
      '3': 12,
      '4': 3,
  ...
  '3': [
    ...
    SearchRequest_ComponentWeightsEntry$json
  ],
  '8': [
    {'1': '_hybrid_query'},
    {'1': '_hybrid_alpha'},
...
@$core.Deprecated('Use searchRequestDescriptor instead')
const SearchRequest_ComponentWeightsEntry$json = {
  '1': 'ComponentWeightsEntry',
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    {'1': 'value', '3': 2, '4': 1, '5': 2, '10': 'value'},
...
final $typed_data.Uint8List filterDescriptor = $convert.base64Decode(
    ...
    'b3AYCCABKAsyFS5oeXBlcnNwYWNlLkZpbHRlck5vdEgAUgVub3RPcBIsCgZwcmVmaXgYCSABKA'
    'syEi5oeXBlcnNwYWNlLlByZWZpeEgAUgZwcmVmaXhCCwoJY29uZGl0aW9u');
...
@$core.Deprecated('Use prefixDescriptor instead')
const Prefix$json = {
  '1': 'Prefix',
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
...
/// Descriptor for `Prefix`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List prefixDescriptor = $convert.base64Decode(
    'CgZQcmVmaXgSEAoDa2V5GAEgASgJUgNrZXkSFgoGcHJlZml4GAIgASgJUgZwcmVmaXg=');
...
final $typed_data.Uint8List searchResultDescriptor = $convert.base64Decode(
    ...
    'FyY2hSZXN1bHQuVHlwZWRNZXRhZGF0YUVudHJ5Ug10eXBlZE1ldGFkYXRhEh0KB3BheWxvYWQY'
    'BSABKAxIAFIHcGF5bG9hZIgBARo7Cg1NZXRhZGF0YUVudHJ5EhAKA2tleRgBIAEoCVIDa2V5Eh'
    'QKBXZhbHVlGAIgASgJUgV2YWx1ZToCOAEaWwoSVHlwZWRNZXRhZGF0YUVudHJ5EhAKA2tleRgB'
    'IAEoCVIDa2V5Ei8KBXZhbHVlGAIgASgLMhkuaHlwZXJzcGFjZS5NZXRhZGF0YVZhbHVlUgV2YW'
    'x1ZToCOAFCCgoIX3BheWxvYWQ=');
...
final $typed_data.Uint8List graphNodeDescriptor = $convert.base64Decode(
    ...
    'YXRhEjMKCmVkZ2VfdHlwZXMYBiADKA4yFC5oeXBlcnNwYWNlLkVkZ2VUeXBlUgllZGdlVHlwZX'
    'MaOwoNTWV0YWRhdGFFbnRyeRIQCgNrZXkYASABKAlSA2tleRIUCgV2YWx1ZRgCIAEoCVIFdmFs'
    'dWU6AjgBGlsKElR5cGVkTWV0YWRhdGFFbnRyeRIQCgNrZXkYASABKAlSA2tleRIvCgV2YWx1ZR'
    'gCIAEoCzIZLmh5cGVyc3BhY2UuTWV0YWRhdGFWYWx1ZVIFdmFsdWU6AjgB');
...
const TraverseRequest$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.hyperspace.TraversalMode',
      '10': 'traversalMode'
    },
    {'1': 'breadth_limit', '3': 9, '4': 1, '5': 13, '10': 'breadthLimit'},
  ],
...
final $typed_data.Uint8List traverseRequestDescriptor = $convert.base64Decode(
    ...
    'LAoHZmlsdGVycxgHIAMoCzISLmh5cGVyc3BhY2UuRmlsdGVyUgdmaWx0ZXJzEkAKDnRyYXZlcn'
    'NhbF9tb2RlGAggASgOMhkuaHlwZXJzcGFjZS5UcmF2ZXJzYWxNb2RlUg10cmF2ZXJzYWxNb2Rl'
    'EiMKDWJyZWFkdGhfbGltaXQYCSABKA1SDGJyZWFkdGhMaW1pdBo5CgtGaWx0ZXJFbnRyeRIQCg'
...
@$core.Deprecated('Use getSubsumptionTreeRequestDescriptor instead')
const GetSubsumptionTreeRequest$json = {
  '1': 'GetSubsumptionTreeRequest',
  '2': [
    {'1': 'collection', '3': 1, '4': 1, '5': 9, '10': 'collection'},
    {'1': 'root_id', '3': 2, '4': 1, '5': 13, '10': 'rootId'},
    {'1': 'max_depth', '3': 3, '4': 1, '5': 13, '10': 'maxDepth'},
  ],
};

/// Descriptor for `GetSubsumptionTreeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getSubsumptionTreeRequestDescriptor = $convert.base64Decode(
    'ChlHZXRTdWJzdW1wdGlvblRyZWVSZXF1ZXN0Eh4KCmNvbGxlY3Rpb24YASABKAlSCmNvbGxlY3'
    'Rpb24SFwoHcm9vdF9pZBgCIAEoDVIGcm9vdElkEhsKCW1heF9kZXB0aBgDIAEoDVIIbWF4RGVw'
    'dGg=');

@$core.Deprecated('Use getSubsumptionTreeResponseDescriptor instead')
const GetSubsumptionTreeResponse$json = {
  '1': 'GetSubsumptionTreeResponse',
  '2': [
    {
      '1': 'nodes',
      '3': 1,
...
/// Descriptor for `GetSubsumptionTreeResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getSubsumptionTreeResponseDescriptor =
    $convert.base64Decode(
        'ChpHZXRTdWJzdW1wdGlvblRyZWVSZXNwb25zZRIrCgVub2RlcxgBIAMoCzIVLmh5cGVyc3BhY2'
        'UuR3JhcGhOb2RlUgVub2Rlcw==');
...
@$core.Deprecated('Use freezeCollectionRequestDescriptor instead')
const FreezeCollectionRequest$json = {
  '1': 'FreezeCollectionRequest',
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
  ],
};

/// Descriptor for `FreezeCollectionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List freezeCollectionRequestDescriptor =
    $convert.base64Decode(
        'ChdGcmVlemVDb2xsZWN0aW9uUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1l');

@$core.Deprecated('Use unfreezeCollectionRequestDescriptor instead')
const UnfreezeCollectionRequest$json = {
  '1': 'UnfreezeCollectionRequest',
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
  ],
};

/// Descriptor for `UnfreezeCollectionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List unfreezeCollectionRequestDescriptor =
    $convert.base64Decode(
        'ChlVbmZyZWV6ZUNvbGxlY3Rpb25SZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
